...
script.onload = function () {
    ...
    $(document).ready(function () {
        ...
        $('.cont').on('mousedown touchstart', '.slide', function (e) {
            if (animation) return;
        ...
        $('.cont').on('mouseup touchend', function (e) {
        ...
        //     let delta = e.originalEvent.wheelDelta || -e.originalEvent.wheelDelta.detail;
